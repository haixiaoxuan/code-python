...
class Linear(tf.keras.Model):
    def __init__(self):
        ...
        self.dense = tf.keras.layers.Dense(
            ...
            use_bias=True,  # 是否加入偏置项
            kernel_initializer=tf.zeros_initializer(),  # 默认 tf.glorot_uniform_initializer
...
# 自定义评估指标
# 需要继承 tf.keras.metrics.Metric 类，并重写 __init__ 、 update_state 和 result 三个方法
